...
export default function DesignSystemPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Storybook Link - Right */}
      <a
        href="/storybook/index.html"
        target="_blank"
        className="group fixed top-4 right-4 z-30 px-3 py-2 text-sm text-white mix-blend-difference flex items-center gap-1 transition-all duration-200"
      >
        Storybook
        <svg
          width="14"
